...
// see also:  https://akrzemi1.wordpress.com/2020/01/29/requires-expression/
template<typename T>            // C++20: concepts
concept FloatDouble = sizeof(T)>=sizeof(float) && std::floating_point<T>;  // float32 and larger
//concept FloatDouble = sizeof(T)>=sizeof(double) && std::floating_point<T>;  // float64 and larger
...
public:
    ...
    Komplex() : Komplex(T(0),T(0))                           // constructor forwarding  
    { }
