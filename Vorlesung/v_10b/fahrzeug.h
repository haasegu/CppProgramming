...
class Fahrzeug
{
    public:
        ...
        */
        ...
        virtual std::string classname() const {return "Fahrzeug";}
...
public:
    /** Default constructor
        ...
        */
        ...
        std::string classname() const override {return "LKW";}
...
public:
    /** Default constructor
        ...
        */
        ...
        std::string classname() const override {return "PKW";}
...
public:
        ...
        std::string classname() const override {return "MAN";}
        float  verbrauch() const override {return 15.1f + Get_load()*0.3f/1000;}
};
...
public:
        ...
        std::string classname() const override {return "Raba";}
        float  verbrauch() const override {return 12.1f + Get_load()*0.4f/1000;}
...
public:
        ...
        std::string classname() const override {return "Opel";}
        float  verbrauch() const override {return 4.5f + Get_pass()*0.2f;}
...
public:
        ...
        std::string classname() const override {return "Smart";}
        float  verbrauch() const override {return 3.1f + Get_pass()*0.4f;}
