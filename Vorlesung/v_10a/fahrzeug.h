...
class Fahrzeug
{
    public:
        ...
        */
        ...
        std::string classname() const {return "Fahrzeug";}

        /** Fuel consumption
         * \return fuel consumption liter per 100 km
         */
        float verbrauch() const {return 0;}         // dummy method ==> virtual ==> abstract
...
public:
    /** Default constructor
        ...
        */
        ...
        std::string classname() const {return "LKW";}
...
public:
    /** Default constructor
        ...
        */
        ...
        std::string classname() const {return "PKW";}
...
public:
        ...
        std::string classname() const {return "MAN";}
...
public:
        ...
        std::string classname() const {return "Raba";}
...
public:
        ...
        std::string classname() const {return "Opel";}
...
public:
        ...
        std::string classname() const {return "Smart";}
