//  Vorlesung 9.5.2014
//  Musterloesung von	SS14, Aufgabe 12 : Fibonacci
//	           g++ -O2  -Wall -pedantic -Wunused -Wredundant-decls  -Wundef  -Wuninitialized  main.cpp
...
T fibo(T& n)
{
    ...
    while (fn>=f1)     // Abbruch falls fn<0 (da f1>=0)
    {
        ++n;
        f2 = f1;
        f1 = fn;
...
void check_fibo2()
{
//    static_assert(is_integral<T>,"Kein integraler Typ");         // erst ab g++-4.7
