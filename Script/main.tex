...
\usepackage{pdflscape}       %% 2024-03-22
...
\protect\newcommand {\htmladdnormallinkfoot}[2] {#1\footnote{\url{#2}}}
...
%\lstset{breaklines=false,breakatwhitespace=true,breakindent=20pt,breakautoindent=true}
%
...
{%
  ...
  label=lst:#2,
   ...
   \marginpar{\href{http://imsc.uni-graz.at/haasegu/Lectures/Kurs-C/Beispiele/#2}{\fbox{\tiny\nolinkurl{#2}}}}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\nocite{SchaderKuhlins:1998:PCP,SpillnerBreymann:2016:LTP,Strasser:2003:PMS,Stroustrup:2000:CPP,Stroustrup:2010:EPC}
%\nocite{Will:2012:CPT,Will:2018:CPT,Will:2020:CMC,Will:2020:CGD}
